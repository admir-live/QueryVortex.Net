...
/// <summary>
///     Represents an operator that checks if the value of a column is greater than a specified value.
/// </summary>
public class GreaterThanOperator : ICondition
{
    ...
    /// <summary>
    ///     Applies a WHERE clause to the specified query using the greater than operator to check if the value of the
    ///     specified column
